...
///   [`gstd::error::Error`](https://doc.rust-lang.org/std/error/trait.Error.html)
/// - [`gstd::io::Error`](https://doc.rust-lang.org/std/io/struct.Error.html) implements
...
impl Error {
  ...
  ///
  /// This method is identical to [`gstd::io::Error::raw_os_error()`][1], except

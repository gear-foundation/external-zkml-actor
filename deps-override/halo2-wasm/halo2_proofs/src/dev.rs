...
use gstd::fmt;
use gstd::iter;
use gstd::ops::{Add, Mul, Neg, Range};
...
impl<F: Field> Assignment<F> for MockProver<F> {
        ...
        AR: Into<String>,
    {
        ...
        self.selectors[selector.0 as usize][row] = true;
...
impl<F: FromUniformBytes<64> + Ord> MockProver<F> {
    ...
    pub fn run<ConcreteCircuit: Circuit<F>>(
        ...
        assert_eq!(instance.len(), cs.num_instance_columns as usize);
        ...
        let fixed = vec![vec![CellValue::Unassigned; n]; cs.num_fixed_columns as usize];
        let selectors = vec![vec![false; n]; cs.num_selectors as usize];
        ...
        let advice = vec![
            ...
            cs.num_advice_columns as usize
        ];
        ...
        let challenges = {
            ...
            .take(cs.num_challenges as usize)
            .collect()
        };

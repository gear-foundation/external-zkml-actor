...
mod test {
    ...
    use gstd::io::{Read, Write};
    use halo2curves_wasm::CurveAffine;
    ...
    fn test_roundtrip_ipa() {
        ...
        use halo2curves_wasm::pasta::{Ep, EqAffine, Fp};
    ...
    fn test_roundtrip_gwc() {
        ...
        use halo2curves_wasm::bn256::{Bn256, G1Affine};
    ...
    >(
        ...
        let valid_queries = gstd::iter::empty()
        ...
        let invalid_queries = gstd::iter::empty()
            .chain(Some(VerifierQuery::new_commitment(&a, x.get_scalar(), avx)))

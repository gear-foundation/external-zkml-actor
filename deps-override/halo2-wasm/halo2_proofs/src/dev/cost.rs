...
impl<G: PrimeGroup, ConcreteCircuit: Circuit<G::Scalar>> CircuitCost<G, ConcreteCircuit> {
    ...
    pub fn measure(k: usize, circuit: &ConcreteCircuit) -> Self {
        ...
        let mut assembly = Assembly {
            selectors: vec![vec![false; 1 << k]; cs.num_selectors as usize],
        };
        ...
        let mut column_queries: HashMap<Column<Any>, BTreeSet<i32>> = HashMap::new();
        ...
        let mut point_sets: BTreeSet<Vec<i32>> = BTreeSet::new();
        ...
        CircuitCost {
            k,
            max_deg,
            advice_columns: cs.num_advice_columns as usize,

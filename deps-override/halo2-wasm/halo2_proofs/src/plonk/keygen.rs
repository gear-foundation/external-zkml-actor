    ...
    C::Scalar: FromUniformBytes<64>,
{
    ...
    let mut assembly: Assembly<C::Scalar> = Assembly {
        k: params.k(),
        fixed: vec![domain.empty_lagrange_assigned(); cs.num_fixed_columns as usize],
        permutation: permutation::keygen::Assembly::new(params.n() as usize, &cs.permutation),
        selectors: vec![vec![false; params.n() as usize]; cs.num_selectors as usize],
    ...
    ConcreteCircuit: Circuit<C::Scalar>,
{
    ...
    let mut assembly: Assembly<C::Scalar> = Assembly {
        k: params.k(),
        fixed: vec![vk.domain.empty_lagrange_assigned(); cs.num_fixed_columns as usize],
        permutation: permutation::keygen::Assembly::new(params.n() as usize, &cs.permutation),
        selectors: vec![vec![false; params.n() as usize]; cs.num_selectors as usize],
        usable_rows: 0..params.n() as usize - (cs.blinding_factors() + 1),
        _marker: gstd::marker::PhantomData,

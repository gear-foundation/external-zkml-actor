...
use halo2_proofs_wasm::arithmetic::Field;
use halo2_proofs_wasm::circuit::{Cell, Layouter, SimpleFloorPlanner, Value};
use halo2_proofs_wasm::dev::MockProver;
use halo2_proofs_wasm::plonk::{
...
use halo2_proofs_wasm::poly::commitment::{CommitmentScheme, ParamsProver, Prover, Verifier};
use halo2_proofs_wasm::poly::Rotation;
use halo2_proofs_wasm::poly::VerificationStrategy;
use halo2_proofs_wasm::transcript::{
...
fn plonk_api() {
    ...
    fn test_plonk_api_gwc() {
        use halo2_proofs_wasm::poly::kzg::commitment::{KZGCommitmentScheme, ParamsKZG};
        use halo2_proofs_wasm::poly::kzg::multiopen::{ProverGWC, VerifierGWC};
        use halo2_proofs_wasm::poly::kzg::strategy::AccumulatorStrategy;
        use halo2curves_wasm::bn256::Bn256;
    ...
    fn test_plonk_api_shplonk() {
        use halo2_proofs_wasm::poly::kzg::commitment::{KZGCommitmentScheme, ParamsKZG};
        use halo2_proofs_wasm::poly::kzg::multiopen::{ProverSHPLONK, VerifierSHPLONK};
        use halo2_proofs_wasm::poly::kzg::strategy::AccumulatorStrategy;
        use halo2curves_wasm::bn256::Bn256;
    ...
    fn test_plonk_api_ipa() {
        use halo2_proofs_wasm::poly::ipa::commitment::{IPACommitmentScheme, ParamsIPA};
        use halo2_proofs_wasm::poly::ipa::multiopen::{ProverIPA, VerifierIPA};
        use halo2_proofs_wasm::poly::ipa::strategy::AccumulatorStrategy;
        use halo2curves_wasm::pasta::EqAffine;

...
#[derive(Clone, Copy, Debug, Eq, PartialEq, Hash, codec::Encode)]
...
pub(crate) mod sealed {
    ...
    #[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, codec::Encode)]
...
/// An advice column
#[derive(Clone, Copy, Eq, PartialEq, Hash, codec::Encode)]
pub struct Advice {
...
/// }
/// ```
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, codec::Encode)]
